...
BLOCKPATH =  strcat(root,'\MATLAB\TDTbin2mat\Photometry\68 & 69\68_and_69-191031-143752'); 
...
[BehavData,ABETfile,Descriptives, block_end, largeRewSide, smallRewSide]=ABET2TableFn_Chamber_A_v6('68 10312019.csv',[]);

SLEAP_data = readtable('RRD68_10312019_body_sleap_data.csv');
...
[BehavData, boris_Extract_tbl] = boris_to_table(boris_file, BehavData, block_end, largeRewSide, smallRewSide);
...
[data, zall_motion, allSignals_motion] = SLEAP_Filter(data, allSignals,SLEAP_data, TRANGE, BASELINE_PER, SLEAP_time_range_adjustment);
% [data, downsample_factor, zall_motion, allSignals_motion] = SLEAP_Filter(data, allSignals,SLEAP_data, TRANGE, BASELINE_PER);

clear SLEAP_data

%%
% downsample 10x and average 405 signal
N = 33.8822618125484; %N = downsample_factor; %downsample_factor; %10
...
trial_select = 27; %select which trial to view
...
entrystep = tracestep;
imstep = 0;
tracefactor = 4; %scale the signal in frame
