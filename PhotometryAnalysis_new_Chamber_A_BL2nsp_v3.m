...
BLOCKPATH =  strcat(root,'\MATLAB\TDTbin2mat\Photometry\165\165-210104-145559');
...
[BehavData,ABETfile,Descriptives, block_end]=ABET2TableFn_Chamber_Av4('165 01042021.csv',[]);
...
BehavData=TrialFilter(BehavData,'REW',0.3,'BLOCK',3);
